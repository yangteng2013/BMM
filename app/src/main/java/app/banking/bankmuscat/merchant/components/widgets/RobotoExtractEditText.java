...
import app.banking.bankmuscat.merchant.util.RobotoTextViewUtils;
...
public class RobotoExtractEditText extends ExtractEditText {
     ...
     * @see #RobotoExtractEditText(Context, AttributeSet, int)
     */
    public RobotoExtractEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
     ...
     * @see #RobotoExtractEditText(Context, AttributeSet)
     */
    public RobotoExtractEditText(Context context, AttributeSet attrs, int defStyle) {
